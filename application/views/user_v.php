                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group input-group-sm">
                              <span class="input-group-addon">
                                <input type="checkbox" name="i_check_employee" id="i_check" onchange="check_employee()" value="1" >
                              </span>
                              <div id="name_user" style="display: none;">
                                <input type="text" class="form-control" name="i_name" id="i_name" placeholder="Masukkan Nama"  value="">
                              </div>
                              <div id="name_employee" style="display: none;">
        ...
        $.ajax({
          ...
          success:function(data){
            for(var i=0; i<data.val.length;i++){
              ...
              if (data.val[i].employee_id == 0) {
                document.getElementById('name_employee').style.display = 'none';
                document.getElementById('name_user').style.display = 'block';
                document.getElementById("i_check").checked = false;
              } else{
                document.getElementById('name_employee').style.display = 'block';
    ...
    function select_list_user_type() {
      ...
      function select_list_employee() {
        $('#i_employee').select2({
          ...
          allowClear: true,
          ajax: {
            url: '<?php echo base_url();?>Employee/load_data_select_employee/'+ 1,
            dataType: 'json',
            delay: 100,
            cache: true,
            data: function (params) {
      ...
      function check_employee(){
        var check = document.getElementById('i_check');
