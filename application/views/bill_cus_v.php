                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <!--<div class="form-group">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <label>
                                <input type="radio" onclick="type_payment(3)" name="i_type" id="inlineRadio3" value="2"> BG
                            </label>
                          </div>
                          ...
                          <div id="transfer" style="display: none;">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="i_rek" id="i_rek" placeholder="Masukkan Nomor Rekening"  value="">
                            </div>
                            <div class="form-group">
